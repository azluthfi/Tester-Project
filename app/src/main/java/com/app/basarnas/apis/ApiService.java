...
//    @FormUrlEncoded
//    @POST("APIcontent.php")
//    Observable<RequestContent> apiContentRequest(@FieldMap Map<String, String> params);
//
//    @FormUrlEncoded
//    @POST("APIuser.php")
//    Observable<RequestBase> apiUserRequest(@FieldMap Map<String, String> params);
//
//    @FormUrlEncoded
//    @POST("APIbisnismu.php")
//    Observable<RequestMsisdn> apiPPOBRequest(@FieldMap Map<String, String> params);
//
//    @POST("APIbisnismu.php")
//    @FormUrlEncoded
