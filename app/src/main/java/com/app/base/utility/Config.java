...
public class Config {
    ...
    public static final String BASE_URL = "https://wl.creasif.com/apiv1devel/";
    static final String APP_NAME = ".-WhiteLabel-.";
    static final boolean DEBUG_MODE = true;
    static final String LOG_TAG = ".-WhiteLabel-.";
    public static final String GOOGLE_SIGN_IN_API = ".-WhiteLabel-.";
